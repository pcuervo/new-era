...
if (!function_exists('pwe_create_wisdm_sidebar')) :
   ...
   <div id="wisdm_main_content">
    ...
    <div id="wisdm_container">
        ...
        <a href="http://wordpress.org/support/view/plugin-reviews/<?php echo $wdm_plugin_slug;
        ?>" target="_blank"><div id="rating-stars"></div></a>
	 ...
	 <li><a href="http://profiles.wordpress.org/WisdmLabs/" target="_blank">More Plugins</a></li>
        ...
        <ul id="right-list">
            <li><a href="http://wordpress.org/support/plugin/<?php echo $wdm_plugin_slug;
	 ...
	 <img alt="" border="0" src="https://www.paypalobjects.com/en_US/i/scr/pixel.gif" width="1" height="1">
      ...
      <div id="banner-fade">
        ...
        <ul class="bjqs">
          <li><img src="<?php echo plugins_url('images/wp-plugin-specialists.jpg', __FILE__);
        ?>"></li>
          <li><img src="<?php echo plugins_url('images/api-programming.jpg', __FILE__);
        ?>"></li>
          <li><img src="<?php echo plugins_url('images/eCommerce-solutions.jpg', __FILE__);
        ?>"></li>
          <li><img src="<?php echo plugins_url('images/responsive-design.jpg', __FILE__);
        ?>"></li>
        </ul>
