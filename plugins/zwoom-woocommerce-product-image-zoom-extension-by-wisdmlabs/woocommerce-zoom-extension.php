 ...
 */
add_action('wp_enqueue_scripts', 'enqueuezoomscript');
add_action('in_plugin_update_message-zwoom-woocommerce-product-image-zoom-extension-by-wisdmlabs/zwoom-woocommerce-product-image-zoom-extension-by-wisdmlabs.php', 'wdm_get_update_notifications');
