...
?>
<li itemprop="review" itemscope itemtype="http://schema.org/Review" class="htheme_comment_li" id="li-comment-<?php comment_ID() ?>">

	<div class="htheme_comment_holder">

		<?php echo get_avatar( $comment, apply_filters( 'woocommerce_review_gravatar_size', '60' ), '' ); ?>

		<div class="htheme_review_text">
			...
			<div itemprop="description" class="description htheme_comment_description"><?php comment_text(); ?></div>
