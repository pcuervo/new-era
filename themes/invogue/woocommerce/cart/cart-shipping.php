...
<tr class="shipping">
	<td data-title="<?php echo esc_attr( $package_name ); ?>" colspan="2">
		...
		<div class="htheme_cart_footer_row" data-title="<?php echo esc_attr( $package_name ); ?>">

			<div class="htheme_shipping_holder">

				<span class="htheme_cart_shipping"><h4><?php echo wp_kses_post( $package_name ); ?></h4></span>
