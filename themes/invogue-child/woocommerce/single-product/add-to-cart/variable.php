...
<?php if( $product->is_type( 'variable' ) ): ?>
	...
	<!-- product variable -->
	<form class="variations_form cart [ no-margin ]" method="post" enctype='multipart/form-data' data-product_id="<?php echo absint( $product->id ); ?>" data-product_variations="<?php echo htmlspecialchars( json_encode( $available_variations ) ) ?>">
