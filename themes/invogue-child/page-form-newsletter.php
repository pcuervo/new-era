							    ...
							    <div class="lightbox">
							       ...
							       <form action="#" method="post" id="suscribirse">
							                ...
							                <div class="campo campo-style">
							                    <input id="webform_style_0" type="checkbox" name="custom_style[]" value="Completa tu estilo, completa otras colecciones" class="street-style"/>
							                    <label class="paloma" for="webform_style_0"></label> 
							                    <label for="webform_style_0" class="style nombre "><strong>Street Style</strong>, mis gorras son simplemente parte de mi estilo</label>
							                </div>
							                <!-- Campaign token -->
